...
import { AddCircleRounded, Category, CloseRounded, CurrencyRupeeRounded, DescriptionRounded, Groups3, InventoryRounded, ProductionQuantityLimitsRounded, QrCodeScannerRounded, StyleRounded, TagRounded } from '@mui/icons-material';
...
export default function NewProducts() {
	...
	const handleSubmit = async (e: any) => {
		...
		else
		{
			...
			const productData = { title: getTitle, selectCategory: getSelectCategory, selectSeller: getSelectSeller, sku: getSKU, quantity: getQuantity, barcode: getBarcode, productPrice: getProductPrice, salePrice: getSalePrice, slug: slug, tags: getTags, description: getDescription, image: imagePath };
