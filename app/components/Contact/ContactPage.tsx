...
export default function ContactPage({ caller }: ContactPageProps) {
	...
	return (
		<motion.div ref={container} style={{position: "relative", width: "100%", height: "100%"}}>
			<motion.div style={{ y }} className={caller === "earthline-made" ? styles.contactE : styles.contactH}>
								...
								<div className={styles.title}>
									...
									<div className={styles.imageContainerOtherVenture}>
										<div className={`flex align-center justify-end`}>
											<Image src={`${caller === 'earthline-made' ? HandoutStudioLogo.src : earthlineLogo.src }`} alt="logo" width={0} height={0} priority />
										</div>
									...
									<div>
										<motion.div style={{x}} className={styles.buttonContainer}>
											<RoundedPage backgroundColor={caller === "earthline-made" ? "#564F47" : "#FFFFFF"} caller={caller}>
												...
												{/* <div className={`text-xs flex w-full items-center`}>
													<p>
											...
											<div className="flex items-center justify-evenly w-full flex-col gap-5">
												...
												<div className={`flex flex-col gap-5`}>
													<div className={`flex flex-col w-full justify-evenly items-center gap-10`}>
														...
														<div className={`text-xs flex gap-2 w-full items-center border-[#564F47] border! p-3 rounded-full`}>
															<Avatar alt="Handout Studios" src={HandoutStudioLogo.src} />
															{`handout studio x earthline.made`}
															<Avatar alt="Earthline Made" src={earthlineLogo.src} />
														</div>
													</div>
												</div>
											</div>
