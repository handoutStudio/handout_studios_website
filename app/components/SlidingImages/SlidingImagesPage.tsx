...
import styles from '@/app/components/SlidingImages/style.module.scss';
...
export default function SlidingImagesPage() {
					...
					slider1.map( (project, index) =>
						<div key={index} className={styles.project} style={{backgroundColor: project.color}}>
							<div className={styles.imageContainer}>
								<ResponsiveImage src={`/images/${project.src}`} alt="image"/>
							</div>
						</div>
					)
				}
